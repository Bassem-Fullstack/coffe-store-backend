...
const category = await Category.findOne({
 ...
 // يعني بدل ما المستخدم يكتب ايدي ممكن يكتب اسم فئة ويجيلوة كل منتجات تبع فئة دي
//  عشان نلغي حروف كابتل وسمول ويجبلي اقرب اسم لاقرب كلمة
})
...
}  //هات المنتجات اللي category بتاعتها = ده الـ ID

// قولتلوة لما مستخدم يكتب اسم في شريط بحث هاتلي منتجات خاص بفئة دي طبعا هنا في فلتر مررت لهو الايدي عشان يعرف يجبلي دة تبع فئة اية عشان من غير ايدي هو مش هيعرف يبعت داتا او فئة بتاعتك دي
